...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if ($pauliTest->simpanHasilTest($_SESSION['participant_id'], $hasilOlahan)) {
            // Redirect ke results
            header("Location: results.php?test=pauli");
            exit();
        } else {
...
// Data untuk test Pauli (deret angka)
$deret = [];
$jumlahKolom = 10;
$jumlahBaris = 10;

// Generate deret angka acak untuk test Pauli (0-9)
...
<body>
    <div class="container">
        ...
        <div class="instructions">
            ...
            <ul>
                <li>Test Pauli mengukur kecepatan, ketelitian, dan konsistensi kerja</li>
                ...
                <li>Test Pauli mirip dengan Kraepelin tetapi dengan interpretasi hasil yang berbeda</li>
            </ul>
        </div>
    ...
    <script>
        ...
        function updateTimer() {
            ...
            if (timeLeft > 0) {
                ...
                document.getElementById('pauli-test-form').submit();
            }
        }
